        ...
        <nav className="w-full bg-gradient-to-r from-purple-500 to-purple-800 text-gray-800 py-0 px-2 shadow-lg fixed top-0 left-0 z-30">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                <div className="flex items-center">
                    ...
                    <a href="/" className="ml-[7.5px] text-2xl font-extrabold text-white hover:text-purple-300 transition-colors duration-300">
                        Nova Serra Roxa
                    </a>
                </div>
            ...
            {/* Mobile Menu */}
            <div className={`lg:hidden bg-gradient-to-r from-purple-500 to-purple-800 p-4 transition-all duration-300 ${isMenuOpen ? 'block' : 'hidden'}`}>
                {menuLinks}
            </div>
        </nav>
    );
